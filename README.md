...
MMRAG 是一个面向 GitHub 仓库文档、Issue、PR Discussion 的多 Agent 知识库 RAG 项目。它为 Xiaomi MiMo 这类 Agent 能力评估场景而设计，重点展示：
...
- [申请回答草稿](APPLICATION_ANSWER_zh.md)
